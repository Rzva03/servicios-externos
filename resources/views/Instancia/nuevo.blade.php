    ...
    <div class="container">
        <form method="POST" action="{{ route('instancia.store') }}">
            ...
            <div class="mb-3">
                ...
                <br>
                <select name="sltSector" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"
                    required>
                ...
                <br>
                <select name="sltTipoSector" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"
                    required>
                    <option selected>Eliga el Tipo de sector</option>
                    @foreach ($tipoSectores as $tipoSector)
                        <option value="{{ $tipoSector->idTipoSec }}">{{ $tipoSector->nomTipoSec }}</option>
                    @endforeach
                </select>
                <br>
                <select name="sltAreaConocimiento class=" form-select form-select-lg mb-3"
                    ...
                    @foreach ($areaConocimientos as $areaConocimiento)
                        <option value="{{ $areaConocimiento->idAreaC }}">{{ $areaConocimiento->nomAreaC }}</option>
                    @endforeach
                </select>
            </div>
